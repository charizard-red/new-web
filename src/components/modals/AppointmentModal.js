      ...
      <div>
        <Modal isOpen={this.props.modal} toggle={this.props.toggle}>
          <ModalHeader toggle={this.props.toggle}>
            {this.props.klinik_data.title}
          </ModalHeader>
          <ModalBody>
            <div>
              <b>Name: </b>
              {this.props.doctor_data.name}
              <br />
              <b>Specialist: </b>
              {this.props.doctor_data.specialist}
              <br />
              <b>Cost: </b>
              {this.props.doctor_data.cost}
              <br />
          ...
          <ModalFooter>
            ...
            <Button color="success" onClick={this.addAppointment}>
              Make Appointment
            </Button>
          </ModalFooter>
        </Modal>
