      ...
      <div>
        ...
        <div className="poweredbyflex">
          <div className="fixsizepoweredby">
            <a href="#" ><img className="poweredbyiconsize poweredbycentral" src={ReactJsLogo} /> </a>
          </div>

          <div className="fixsizepoweredby">
            <a href="#" ><img className="poweredbyiconsize poweredbycentral" src={MongooseLogo} /> </a>
          </div>

          <div className="fixsizepoweredby">
            <img className="poweredbyiconsize poweredbycentral" src={BootstrapLogo} />
          </div>
